...
INSERT INTO Student (Stud_id, Name, Class) VALUES
    ...
    (3, 'Bob Johnson', 'Class A'),
    (4, 'Alice Brown', 'Class C');

-- Insert data into the Competition table
INSERT INTO Competition (C_no, C_name, Type) VALUES
    (11, 'Math Competition', 'Academic'),
    (12, 'Sports Day', 'Sports'),
    (13, 'Art Exhibition', 'Cultural');
